...
<ul class="nav nav-pills">
  <li role="presentation" id="addParentBtn"><a onclick="gridRenderInvAdd('invAddParent.php');">Add Parent</a></li>
  <li role="presentation" class="active" id="addChildBtn"><a onclick="gridRenderInvAdd('invAddChild.php');">Add Child</a></li>
...
<form>
  ...
  <div class="form-group">
    <label for="invAddName">Child Label</label>
    <div class="input-group">
      <span class="input-group-addon">Label</span>
      <input type="" class="form-control" id="invAddName" placeholder="0mg; Red; etc." />
    </div>
  </div>
